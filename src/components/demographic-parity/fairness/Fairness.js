...
const fairnessProContent = [
  ...
  'Still, many remain unconvinced. In the next chapter, we will delve into equal opportunity, another conception of fairness that is in many ways less demanding than demographic parity.'
]
