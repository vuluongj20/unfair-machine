      ...
      ScrollTrigger.create({
        ...
        animation: gsap.timeline()
          .add(gsap.fromTo(
            ...
            { drawSVG: 0 }, { drawSVG: '100%', ease: 'power2.out', duration: 0.6, stagger: 0.3 }), 0)
          .add(gsap.fromTo(
            ['.eof-viz-ground-text'], 
            { opacity: 0 }, { opacity: 1, ease: 'power2.out', duration: 0.6 }), 0.3)
          .add(gsap.fromTo(
            ['.eof-viz-prediction-circle', '.eof-viz-prediction-line', '.eof-viz-prediction-text'], 
            { opacity: 0 }, { opacity: 1, ease: 'power2.out', duration: 0.6, stagger: 0.04 }), 0.4)
          .add(gsap.fromTo(
            ['.eof-viz-area'], 
            { opacity: 0 }, { opacity: 1, ease: 'power2.out', duration: 0.4}), 0.6)
