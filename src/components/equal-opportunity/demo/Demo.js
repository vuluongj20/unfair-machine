    ...
    return (
      <div className="eo-demo-canvas by">
        <div className="eod-viz-wrap flex-center">
          <div className="eod-interactive-wrap flex-center col-4">
            <div className="eod-interactive-prompt-wrap">
              <p className="eod-interactive-prompt">
                {interactiveContent.prompt}
              </p>
              {interactiveContent.hints.map((hint, index) => {
                return (
                  <p className="eod-interactive-hint" key={index}>
                    {hint}
                  </p>
                )
              })}
              ...
              {data.general && (
                <Viz
                  ...
                  animationTriggers={section =>
                    `#eod-scroll-section-${section.id}  > .eod-scroll-text-wrap`
                  }
                  options={generalOptions}
                  threshold={thresholds.general}
                  setThreshold={threshold =>
                    this.setThreshold("general", threshold)
                  }
                />
              )}
            </div>
        ...
        <div className="eod-scroll-area">
          ...
          <div
            className="eod-scroll-area-main"
          ...
          >
            {scrollContent.map(section => {
              return (
                ...
                >
                  <div
                    className={`eod-scroll-text-wrap col-${section.width} col-${
                      section.mobileWidth
                    }-sm ${!section.text ? "empty" : ""}`}
                  >
