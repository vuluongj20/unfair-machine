...
class Demo extends Component {
  ...
  componentDidMount() {
    document.addEventListener(
      "media-loaded",
      () => {
        gsap.to(".dp-demo", { opacity: 1, ease: "expo.out", duration: 1.6 })
        this.stInstances.push(
          ScrollTrigger.create({
            ...
            pin: ".dpd-viz-wrap",
            onLeave: () =>
              gsap.to([`.dpd-scroll-arrow`, `.dpd-scroll-arrow-label`], {
                opacity: 0,
                ease: "expo.out",
                duration: 0.6,
              }),
            ...
            ScrollTrigger.create({
              ...
              animation: gsap
                ...
                .add(
                  gsap.to(
                    `#dpd-scroll-section-${section.id} > .dpd-scroll-text-wrap`,
                    { opacity: 0, scale: 0.8, duration: 0.5, ease: "power4.in" }
                  ),
                  0.5
                ),
            })
        ...
        setTimeout(() => {
          ...
          endAnimations[0].animations.forEach(animation => {
            ...
            if (animation.from) {
              endTimeline.add(
                gsap.fromTo(
                  `${animation.externalTarget ? "" : target} ${
                    animation.target
                  }`,
                  animation.from,
                  toObject
          ...
          this.stInstances.push(
            ScrollTrigger.create({
              ...
              onEnter: () => {
                endTimeline.duration(1.6).play(0)
              },
              onLeaveBack: () => {
                onLeaveBack(endAnimations.trigger)
              },
            })
          )
        }, 1000)
    ...
    return (
      <div className="dp-demo by">
          ...
          <div className="dpd-viz-inner-wrap row">
            ...
            <div className="dpd-interactive-wrap flex-center col-4">
              <div className="dpd-interactive-prompt-wrap">
                <p className="dpd-interactive-prompt">
                  {interactiveContent.prompt}
                </p>
                {interactiveContent.hints.map((hint, index) => {
                  return (
                    <p className="dpd-interactive-hint" key={index}>
                      {hint}
                    </p>
                  )
                })}
              ...
              <div className="dpd-interactive-results-wrap absolute-center flex-center">
                <div className="dpd-interactive-result-wrap flex-center">
                  ...
                  <div className="dpd-interactive-result-acceptance-wrap">
                    <p className="dpd-interactive-label">
        ...
        <div className="dpd-scroll-area">
          ...
          <div
            className="dpd-scroll-area-main"
            style={{ height: `${scrollContent.length * 80}vh` }}
          >
