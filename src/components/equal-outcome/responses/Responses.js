...
const treatmentBody = [
  ...
  'We can extend corrective justice to the case of defendant risk assessment. We may reason that African-American defendants have been more likely to reoffend due to an unjust legal and social system. African-American ex-prisoners face prejudice from parole officers and overwhelming stigma within society, to a worse degree than Caucasian ex-prisoners. As such, they are more likely to break parole or reoffend. From this, we may reason that outcome-equal decision-making models are justified in extending disparate treatment to different racial groups, because such treatment helps correct the mentioned injustices.',
      ...
      <div className="dp-fairness article-wrap my-4">
        <div className="heading-wrap center mt-3">
          <div className="heading-inner-wrap">
            ...
            <h2 className="heading">Objections</h2>
