...
const headingQuote = 'Some stakeholders may object to the use of Equality of Outcome in decision-making models. There are two main objections that warrant further discussion.'
