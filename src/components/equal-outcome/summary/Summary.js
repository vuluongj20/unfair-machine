...
const headingQuote = 'Equality of Outcome is an equality-based conception of fairness, but there are concerns about its rather stringent requirements.'
const body = ['Outcome-equal models prioritize outcome fairness over procedural fairness. The quantity of equalization - the prediction rate - is a simple yet effective one. However, there are concerns about its effects on the models\' accuracy, and whether it is the right quantity to equalize in the first place.',
